...
class DeepLakeDataModule(LightningDataModule):
    ...
    def add_argparse_args(parent_parser):
        ...
        parser.add_argument('--path', type=str, default="s3://...", help='size of the images')
        parser.add_argument('--token', type=str, default="", help='token for accessing the dataset (optional)')
        return parser
    ...
    def train_dataloader(self):
        ...
        txt_transform_local = lambda txt: txt_transform(txt, custom_tokenizer=custom_tokenizer)
        update_collate_fn = lambda batch: collate_fn(batch, custom_tokenizer=custom_tokenizer)
